...
export function ProductDetailActions({ product }: { product: Product }) {
  ...
  return (
    <div>
      ...
      {outOfStock ? (
        <p className="mb-4 text-sm text-red-600">Agotado por el momento.</p>
      ) : (
      ...
      <button
        onClick={handleAdd}
        disabled={outOfStock}
        className={`flex w-full items-center justify-center gap-2 rounded px-7 py-3.5 text-[13px] uppercase tracking-wider transition disabled:cursor-not-allowed disabled:opacity-50 ${
